      ...
      <div className="flex flex-wrap gap-16 md:flex-nowrap justify-center">
        <div className=" ">
          <p className="w-72 sm:w-80 md:w-80  text-xl font-medium text-gray-600 dark:text-white/75 leading-8 tracking-wide">
            ...
            starting out in the kitchen, we've got you covered with a wide range
            of recipes that are both easy to follow and packed with flavor.
          </p>
        </div>
        <div className=" flex justify-center p-3">
          <img
            ...
            alt=""
            className={`${theme === "dark" ? "hero-img-dark" : "hero-img" } w-[250px]   rounded-3xl`}
          />
        </div>
      </div>
