...
const DisplayChicken = (props) => {
  ...
  return (
    <div>
      <div 
      className={`${theme === "dark" ? "FoodCard-dark" : "FoodCard"}  relative overflow-hidden  w-[200px] h-[280px]  flex flex-col gap-3 items-center `}>
      <img src={strMealThumb} alt="" className="w-[200px] FoodCardImg" />
        <div className="w-44 ">
          <h3 className=" text-xl font-medium text-yellow-500 dark:text-orange-400">{strMeal.substring(0,25)+"..."}</h3>
        </div>
